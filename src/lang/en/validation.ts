export default {
    ...
    */
    ...
    doesnt_end_with:
        'The {{attribute}} may not end with one of the following: {{value}}s.',
    doesnt_start_with:
    ...
    required_unless:
        'The {{attribute}} field is required unless {{other}} is in {{value}}s.',
    required_with:
        'The {{attribute}} field is required when {{value}}s is present.',
    required_with_all:
        'The {{attribute}} field is required when {{value}}s are present.',
    required_without:
        'The {{attribute}} field is required when {{value}}s is not present.',
    ...
    starts_with:
        'The {{attribute}} must start with one of the following: {{value}}s.',
